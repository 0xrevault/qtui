...
Rectangle {
    property string objText: qsTr("功能介绍：此程序为人体关键点。调整“颜色”可以改变关键点的绘制颜色，\
调整“阈值”可以改变识别精度。模型为256x256。采集的图像为640x480。全屏显示时，图像会拉伸，此现象为正常现象。摄像头帧率为30fps")
    anchors.fill: parent
    color: "black"
