...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<WeatherForecast>("com.alientek.qmlcomponents", 1, 0, "WeatherForecast");
    qmlRegisterType<NetworkPosition>("com.alientek.qmlcomponents", 1, 0, "NetworkPosition");
