...
Item {
    ...
    property string system_hour
    property string system_minutes
    signal systemTimeTriggered()
    ...
    Timer{
        ...
        onTriggered:{
            ...
            system_hour = currentHour()
            system_minutes = currentMin()
