...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        color: "#33101010"
        visible: removeFile_drawer_bottom.y === window.height - scaleFfactor * 400
    }
    ...
    Item {
        ...
        function open() {
            ...
            removeFile_drawer_bottom.y = window.height - scaleFfactor * 400
        }

        function close() {
            removeFile_drawer_bottom.y = window.height
