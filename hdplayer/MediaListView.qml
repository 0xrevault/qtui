...
Rectangle {
    color: playListBt.checked ? "transparent" :"#88101010"
    GridView  {
        id: mediaGridView
        visible: true
        anchors.fill: parent
    ...
    PathView  {
        ...
        path:  Path {
            ...
            PathAttribute { name: "viewScale"; value: 0.5}
            ...
            PathAttribute { name: "viewScale"; value: 0.7}
            PathAttribute { name: "viewZ"; value: 5}
            PathAttribute { name: "viewOpacity"; value: 1.0}

            PathLine { x: viewController.width + viewController.width / 2; y:viewController.height / 2}
            PathAttribute { name: "viewScale"; value: 0.5 }
            PathAttribute { name: "viewZ"; value: 0}
            PathAttribute { name: "viewOpacity"; value: 0.5}
